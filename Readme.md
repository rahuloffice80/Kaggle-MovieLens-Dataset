...
# Kaggle Movielens dataset -> CPU approach
...
->Downloading data: 
  ...
  Download all data from above url and extract it in data folder, your final data package should contain ml-latest-small folder from zip


## Project setup: 

cd into movielens folder 
...
(fastai-cpu-dev) ➜  movielens jupyter notebook
